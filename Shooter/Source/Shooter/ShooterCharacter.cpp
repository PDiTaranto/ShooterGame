	...
	bFiringBullet(false)
{
	...
	// Character not rotate with controller
	bUseControllerRotationPitch = false;
	bUseControllerRotationYaw = true;
	bUseControllerRotationRoll = false;

	// Character rotate to direction
...
void AShooterCharacter::CameraInterpZoomed(float DeltaTime)
{
...
void AShooterCharacter::CalculateCrosshairSpread(float DeltaTime)
{
	...
	{
		// Spread the crosshair slowly when in air
	...
	{
		// Shrink the crosshair when on the ground
		CrosshairInAirFactor = FMath::FInterpTo(
			CrosshairInAirFactor,
			0.f,
			DeltaTime,
	...
	{
		// Spread the crosshair when not aiming
		CrosshairAimFactor = FMath::FInterpTo(
			CrosshairAimFactor,
			0.f,
			DeltaTime,
...
void AShooterCharacter::Tick(float DeltaTime)
{
	...
	// Handle interpolation of camera FOV
	CameraInterpZoomed(DeltaTime);
	// Change Look sensitivity based on zoom
	SetLookRates();
